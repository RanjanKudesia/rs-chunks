...
//! Glyph name → Unicode, for `/Differences` encoding arrays.
//!
//! Covers the Adobe Glyph List plus the TeX/Computer-Modern names real
//! academic PDFs use (`summationdisplay`, `parenleftbig`, `epsilon1`, …),
//! which plain AGL does not have. Sorted by name; looked up by binary search.

/// 4495 (name, codepoint) pairs, sorted by name.
pub(crate) static GLYPH_NAMES: &[(&str, u16)] = &[
    ("A", 0x0041),
    ("AE", 0x00c6),
    ("AEacute", 0x01fc),
    ("AEmacron", 0x01e2),
